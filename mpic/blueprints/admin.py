...
from mpic.decorators import admin_required, permission_required
from mpic.extensions import db
from mpic.forms.admin import EditProfileAdminForm
from mpic.models import Role, User, Tag, Photo, Comment
...
@permission_required('MODERATE')
def manage_user():
    filter_rule = request.args.get('filter', 'all')  # 共有all,locked,blocked,administrator,moderator
